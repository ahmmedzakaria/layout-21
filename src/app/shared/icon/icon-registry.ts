...
export const ICONS: Record<string, string> = {
  ...
  map: '<path d="M9 18l-6 3V6l6-3 6 3 6-3v15l-6 3-6-3zM9 3v15M15 6v15" stroke-linecap="round" stroke-linejoin="round"/>',
  briefcase: '<rect x="4" y="7" width="16" height="12" rx="2"/><path d="M9 7V5a2 2 0 012-2h2a2 2 0 012 2v2M4 12h16" stroke-linecap="round" stroke-linejoin="round"/>',
  receipt: '<rect x="4" y="5" width="16" height="14" rx="2"/><path d="M8 9h8M8 13h5M8 17h.01M12 17h.01M16 17h.01" stroke-linecap="round"/>',
  medical: '<path d="M12 5v14M5 12h14" stroke-linecap="round"/><rect x="4" y="4" width="16" height="16" rx="4"/>',
  education: '<path d="M4 9l8-4 8 4-8 4-8-4z"/><path d="M7 12v4c2.8 2 7.2 2 10 0v-4" stroke-linecap="round" stroke-linejoin="round"/>',
  ...
  lock: '<rect x="5" y="10" width="14" height="10" rx="2"/><path d="M8 10V7a4 4 0 018 0v3" stroke-linecap="round"/>',
  shield: '<path d="M12 2l8 3.5v6c0 5-3.4 8.7-8 10.5-4.6-1.8-8-5.5-8-10.5v-6L12 2z"/><path d="M8.5 12l2.3 2.3 4.7-4.8" stroke-linecap="round" stroke-linejoin="round"/>',
  monitor: '<rect x="4" y="6" width="16" height="12" rx="2"/><path d="M7 14l3-3 3 2 4-5M7 18h10" stroke-linecap="round" stroke-linejoin="round"/>',
  'document-lines': '<path d="M7 3h7l4 4v14H7z"/><path d="M14 3v5h4M10 12h5M10 16h5" stroke-linecap="round" stroke-linejoin="round"/>',
  'shield-list': '<path d="M12 3l7 3v5c0 4.4-2.8 7.8-7 10-4.2-2.2-7-5.6-7-10V6l7-3z"/><path d="M8.5 12h7M8.5 15h4M9 9h6" stroke-linecap="round"/>',
  ledger: '<rect x="4" y="4" width="16" height="16" rx="2"/><path d="M8 8h8M8 12h8M8 16h3M15 15l1 1 2-3" stroke-linecap="round" stroke-linejoin="round"/>',
  payroll: '<rect x="4" y="5" width="16" height="14" rx="2"/><path d="M8 10h8M8 14h4M15 14h1.5M8 18h8" stroke-linecap="round"/><path d="M17 5V3M7 5V3" stroke-linecap="round"/>',
  layers: '<path d="M4 9l8-5 8 5-8 5-8-5z"/><path d="M6 12l6 4 6-4M6 16l6 4 6-4" stroke-linecap="round" stroke-linejoin="round"/>',
  ...
  'module-default': '<rect x="4" y="5" width="16" height="14" rx="2"/><path d="M8 9h8M8 13h5M16 17h.01" stroke-linecap="round"/>',
  ...
  alert: '<path d="M12 3l9 16H3l9-16z" stroke-linejoin="round"/><path d="M12 9v4M12 17h.01" stroke-linecap="round"/>',
  'file-alert': '<path d="M6 2h9l5 5v13a2 2 0 01-2 2H6a2 2 0 01-2-2V4a2 2 0 012-2z" stroke-linejoin="round"/><path d="M14 2v5h5M12 10v4M12 18h.01" stroke-linecap="round" stroke-linejoin="round"/>',
  ...
  'expand-list': '<path d="M4 7h16M4 17h16M8 12h8M12 8v8" stroke-linecap="round"/>',
  'collapse-list': '<path d="M4 7h16M4 17h16M8 12h8" stroke-linecap="round"/>',
